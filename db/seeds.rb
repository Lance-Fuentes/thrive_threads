...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/1_women_worth.jpg'), filename: '1_women_worth.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/2_women_ninja.jpg'), filename: '2_women_ninja.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/3_men_tokyo.jpg'), filename: '3_men_tokyo.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/4_men_ea.jpg'), filename: '4_men_ea.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/5_kids_panda.jpg'), filename: '5_kids_panda.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/6_kids_cat.jpg'), filename: '6_kids_cat.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/7_acc_key.jpg'), filename: '7_acc_key.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  category: Category.find_by(name: 'Home & Living')
).tap do |product|
  Image.create(product: product).file.attach(io: File.open('storage/images/8_hl_tumbler.jpg'), filename: '8_hl_tumbler.jpg', content_type: 'image/jpg')
end
...
Product.create(
  ...
  Image.create(product: product).file.attach(io: File.open('storage/images/9_hl_bless.jpg'), filename: '9_hl_bless.jpg', content_type: 'image/jpg')
end
